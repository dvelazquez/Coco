/* 
   ...
   acquires a 1-5 VCD analog signal(PV) with an interfase based on uC. Sends
   a 4-20 mA analog signal to an I/P using a DAC. Communication within ADC - DAC - WS
   is done with a Microchip's PIC16F Family Microcontroller.
...
int i, M, fd, Timer, OPi, Value1, Value2;
